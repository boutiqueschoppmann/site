    ...
    <section className="bg-charbon/3 py-24">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-end justify-between mb-12">
          ...
          <Link href="/boutique" className="group hidden md:inline-flex text-sm text-charbon/50 hover:text-charbon hover:gap-3 transition-all duration-200 gap-2 items-center">
